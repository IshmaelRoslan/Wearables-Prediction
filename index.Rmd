...
Firstly, build a recipe for pre-processing. 1. Remove predictors with at least 90% of data missing (most models do not deal well with missing data)
...
```{r predictions, cache = FALSE}
print(predict(final_fit,testing))
```
